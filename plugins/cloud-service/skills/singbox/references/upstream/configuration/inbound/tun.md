...
!!! quote "Changes in sing-box 1.14.0"
    ...
    :material-plus: [udp_mapping](https://sing-box.sagernet.org/configuration/shared/udp-nat/#udp_mapping)  
    :material-plus: [udp_filtering](https://sing-box.sagernet.org/configuration/shared/udp-nat/#udp_filtering)  
    :material-plus: [udp_nat_max](https://sing-box.sagernet.org/configuration/shared/udp-nat/#udp_nat_max)
...
[network namespace](https://sing-box.sagernet.org/configuration/network-namespace/).
...
Since sing-box 1.14.0, use [UDP NAT fields](https://sing-box.sagernet.org/configuration/shared/udp-nat/)
...
See [UDP NAT Fields](https://sing-box.sagernet.org/configuration/shared/udp-nat/) for details.

### Listen Fields

See [Listen Fields](https://sing-box.sagernet.org/configuration/shared/listen/) for details.
