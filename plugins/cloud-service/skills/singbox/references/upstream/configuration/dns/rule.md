...
!!! quote "Changes in sing-box 1.14.0"
    ...
    [`resolve`](https://sing-box.sagernet.org/configuration/route/rule_action/#resolve) route rule action without a
    `server` set. In earlier versions, only DNS queries received from a
    client evaluated this field. See
    [Migration](../../migration.md#ip_version-and-query_type-behavior-changes-in-dns-rules)
    for the full list.
    ...
    address-based filtering, use the [`evaluate`](https://sing-box.sagernet.org/configuration/dns/rule_action/#evaluate)
...
!!! failure "Deprecated in sing-box 1.8.0"
    ...
    Geosite is deprecated and will be removed in sing-box 1.12.0, check [Migration](../../migration.md#migrate-geosite-to-rule-sets).
...
!!! failure "Deprecated in sing-box 1.8.0"
    ...
    GeoIP is deprecated and will be removed in sing-box 1.12.0, check [Migration](../../migration.md#migrate-geoip-to-rule-sets).
...
!!! failure "Deprecated in sing-box 1.12.0"
    ...
    `outbound` rule items are deprecated and will be removed in sing-box 1.14.0, check [Migration](../../migration.md#migrate-outbound-dns-rule-items-to-domain-resolver). 
...
See [DNS Rule Actions](https://sing-box.sagernet.org/configuration/dns/rule_action/) for details.

#### server

!!! failure "Deprecated in sing-box 1.11.0"

    Moved to [DNS Rule Action](https://sing-box.sagernet.org/configuration/dns/rule_action#route).
...
!!! failure "Deprecated in sing-box 1.14.0"
    ...
    check [Migration](../../migration.md#migrate-address-filter-fields-to-response-matching).
...
!!! failure "Removed in sing-box 1.12.0"
    ...
    GeoIP is deprecated in sing-box 1.8.0 and removed in sing-box 1.12.0, check [Migration](../../migration.md#migrate-geoip-to-rule-sets).
