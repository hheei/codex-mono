...
See [ACME](https://sing-box.sagernet.org/configuration/shared/certificate-provider/acme/) for fields newly added in sing-box 1.14.0.

!!! info "References"

    [TLS](https://sing-box.sagernet.org/configuration/shared/tls/#certificate_provider) /
...
In sing-box 1.14.0, use the [`evaluate`](https://sing-box.sagernet.org/configuration/dns/rule_action/#evaluate) action
to fetch a DNS response, then match against it explicitly with `match_response`.

!!! info "References"

    [DNS Rule](configuration/dns/rule.md) /
    [DNS Rule Action](https://sing-box.sagernet.org/configuration/dns/rule_action/#evaluate)
...
[`ip_version`](configuration/dns/rule.md#ip_version) and
[`query_type`](configuration/dns/rule.md#query_type) in DNS rules, together with
[`query_type`](https://sing-box.sagernet.org/configuration/rule-set/headless-rule/#query_type) in referenced
...
- The [`resolve`](https://sing-box.sagernet.org/configuration/route/rule_action/#resolve) route rule
  action without a `server` set.
- ICMP traffic routed to a domain destination through a `direct` outbound.
- A [WireGuard](https://sing-box.sagernet.org/configuration/endpoint/wireguard/) or
  [Tailscale](configuration/endpoint/tailscale.md) endpoint used as an
  outbound, when resolving its own destination address.
- A [SOCKS4](https://sing-box.sagernet.org/configuration/outbound/socks/) outbound, which must resolve
  the destination locally because the protocol has no in-protocol domain
  support.
- The [DERP](https://sing-box.sagernet.org/configuration/service/derp/) `bootstrap-dns` endpoint and the
  [`resolved`](https://sing-box.sagernet.org/configuration/service/resolved/) service (when resolving a
  hostname or an SRV target).

Resolutions that target a specific DNS server — via
[`domain_resolver`](https://sing-box.sagernet.org/configuration/shared/dial/#domain_resolver) on a dial
field, [`default_domain_resolver`](https://sing-box.sagernet.org/configuration/route/#default_domain_resolver)
...
the [`evaluate`](https://sing-box.sagernet.org/configuration/dns/rule_action/#evaluate) action and
[`match_response`](configuration/dns/rule.md#match_response), see
...
!!! info "References"
    ...
    [Route Rule Action](https://sing-box.sagernet.org/configuration/route/rule_action/#resolve)
...
!!! info "References"
    ...
    [DNS rule](configuration/dns/rule.md#outbound) /
    [Dial Fields](https://sing-box.sagernet.org/configuration/shared/dial/#domain_resolver) /
    [Route](https://sing-box.sagernet.org/configuration/route/#domain_resolver)
...
!!! info "References"
    ...
    [Dial Fields](https://sing-box.sagernet.org/configuration/shared/dial/#domain_strategy)
...
!!! info "References"
    ...
    [Rule Action](https://sing-box.sagernet.org/configuration/route/rule_action/) / 
    [Block](https://sing-box.sagernet.org/configuration/outbound/block/) / 
    [DNS](https://sing-box.sagernet.org/configuration/outbound/dns)
...
!!! info "References"
    ...
    [WireGuard Outbound](https://sing-box.sagernet.org/configuration/outbound/wireguard/)
...
!!! info "References"
    ...
    [GeoIP](https://sing-box.sagernet.org/configuration/route/geoip/) / 
    [Route](https://sing-box.sagernet.org/configuration/route/) / 
    [Route Rule](configuration/route/rule.md) / 
    [DNS Rule](configuration/dns/rule.md) / 
    [rule-set](configuration/rule-set/index.md)
...
!!! info "References"
    ...
    [Geosite](https://sing-box.sagernet.org/configuration/route/geosite/) / 
    [Route](https://sing-box.sagernet.org/configuration/route/) / 
    [Route Rule](configuration/route/rule.md) / 
    [DNS Rule](configuration/dns/rule.md) / 
    [rule-set](configuration/rule-set/index.md)
